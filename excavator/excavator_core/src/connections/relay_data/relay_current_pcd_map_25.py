...
class RelayCurrentPcdMap25:

    def __init__(self):
        
        self.__original_data_subscriber = rospy.Subscriber('/svc/current_pcd_map_25', PointCloud2, self.__message_callback, queue_size = 1)
        self.__relay_data_publisher = rospy.Publisher('/excavator/relay/current_pcd_map_25', RelayPCDInfo, queue_size=1)
...
def main():
    rospy.init_node('excavator_core_relay_current_pcd_map_25', anonymous=True)
    try:
        relay_current_pcd_map_25 = RelayCurrentPcdMap25()
